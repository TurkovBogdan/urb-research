...
//
// Two backends name icons from this set: research groups (`research/icons.py::GROUP_ICONS`, a
// palette the user picks from, served by the `group_icons` MCP tool) and connector groups
// (`core_connectors/connectors/groups.py`, fixed in code). This file is the other half — the only
// place that turns such a name into something renderable. The imports are explicit on purpose:
