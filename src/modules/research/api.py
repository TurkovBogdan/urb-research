...
class AreaDescriptionBody(BaseModel):
    """То же для описания области. Своё тело, а не общее с исследованием: потолок каждой
    сущности — её собственная константа, и общее тело молча пережило бы их расхождение,
    обещав одной из них длину, которой её колонка не примет."""
